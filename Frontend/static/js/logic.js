...
const tiles = 12; // Pixels
const plots = tiles * 9; // Pixels
const roads = tiles * 2; // Pixels
const initialOffsets = plots +roads; // Pixels
const plotViewOffsets = plots + (1 * roads); // Pixels
...
//- State
const mapView = {mapOffsetX:-4.65*initialOffsets,mapOffsetY:-7*initialOffsets};
...
//web3 constants
const contractAddress = "0x8904f53fdAE32EfB6Fc96993DDBF644A7D7E899F"; //your own contract
